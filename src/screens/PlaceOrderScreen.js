                  ...
                  {cart.cartItems.map((item, index) => (
                    <ListGroup.Item key={index}>
                      <Row>
                        ...
                        <Col md={4}>
                          {item.qty} x {item.price}Birr ={" "}
                          {item.qty * item.price} Birr
                        </Col>
                      </Row>
                    </ListGroup.Item>
                  ))}
          ...
          <Card>
            <ListGroup variant="flush">
              ...
              <ListGroup.Item className="push-to-right">
                <Row>
                  <Col>Items</Col>
                  <Col>{cart.itemsPrice}Birr</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item className="push-to-right">
                <Row>
                  <Col>Shipping</Col>
                  <Col>{cart.shippingPrice}Birr</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item className="push-to-right">
                <Row>
                  <Col>Tax</Col>
                  <Col>{cart.taxPrice}Birr</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item className="push-to-right">
                <Row>
                  ...
                  <Col>
                    <strong>{cart.totalPrice}Birr</strong>
                  </Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
